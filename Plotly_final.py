...
# Process data to count asteroids per date for bar chart
...
# Layout of the app
app.layout = html.Div([
    html.H1("Asteroid Data Visualization", style={'textAlign': 'center'}),
    dbc.Tabs([
...
def update_plot_scatter(unit, min_size, max_size, velocity_unit, plot_size, hazardous_color, non_hazardous_color):
    min_col, max_col = unit_options[unit]
